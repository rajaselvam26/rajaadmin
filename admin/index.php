...
// Extension
if(isset($_REQUEST['EXTENSION'])&&$_REQUEST['plug_a']!='') : $p_msg=admin::extension_active($_REQUEST); endif;
if(isset($_REQUEST['EXTENSION'])&&$_REQUEST['plug_d'] !='') : $p_msg=admin::extension_deactive($_REQUEST); endif;
if(isset($_REQUEST['EXTENSION'])&&$_REQUEST['plug_delete'] !='') : $p_msg=admin::extension_delete($_REQUEST); endif;

admin::header_with_menu();

$plug_var=$extension_var='true';

$plug_var = admin::admin_page_integration(); # PLUGIN ADMIN PAGE

$extension_var = admin::admin_page_ext_integration(); # EXTENSION ADMIN PAGE

if($plug_var=='false' && $extension_var=='false'){
