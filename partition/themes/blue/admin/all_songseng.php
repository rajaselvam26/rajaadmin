...
$val=mysql_query("select * from songs_english");
$cou=mysql_num_rows($val);
if(isset($_REQUEST['del_id'])){
$del=mysql_query("delete from  songs_english where rid='".$_REQUEST['del_id']."'");
...
mysql_query("update  songs_english set sid=N'".$sid."',fid=N'".$flimname."',sname=N'".$musdir."',male_singer=N'".$male."',female_singer=N'".$totsongs."',chrous=N'".$chrous."',songlyrics=N'".$editor1."',timings=N'".$fdirector."',lyricist=N'".$fproducer."',genre=N'".$fmusic."',fmtiming=N'".$actors."',imgflag=N'".$flg."' where rid='".$id."'");

header("location:?Theme_admin=all_songseng&Document Management");
	}
...
<div class="title-box">
<h2><b>All Songs (English)&nbsp;(<?php echo $cou; ?>)</b></h2>
</div>
<div class="dash_count"><form  method="post" enctype="multipart/form-data" name="form1">
...
<?php
mysql_query("set character_set_results='utf8'");
$vtb=mysql_query("select * from  songs_english");
while($r=mysql_fetch_object($vtb))
{
	$valu=mysql_query("select * from  flim_english where id='".$r->fid."'");
...
<td align='left'><a href='?Theme_admin=all_songseng&Document Management&id=<?php echo $r->rid?>&n=1'>Edit</a></td></tr>
<?php } ?>
<?php //} ?>
</tr>
</table>
...
{
	?>
	<div id="apDiv1" style="overflow:auto; width:747px  !important; height:434px; !important;"><div align="right"><a href="?Theme_admin=all_songseng&Document Management">Close</a></div>
...
<td align="center"><input type="text" name="male" id="male" value="<?= $r1->male_singer;?>"/> </td>
