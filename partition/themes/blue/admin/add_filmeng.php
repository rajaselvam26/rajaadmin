   ...
   /* $host='localhost'; // Host Name.
    ...
    if($_FILES["file"]["size"] > 0)
    {
        ...
        while (($emapData = fgetcsv($file, 10000, ",")) !== FALSE)
        {
            ...
            //print_r($emapData);
            //exit();
			/*echo  "INSERT into  songs_english(fid,sid,sname,male_singer,female_singer,songlyrics,timings,lyricist,genre,fmtiming,flag,imgflag,likes,comments) values (N'$emapData[0]',N'$emapData[1]',N'$emapData[2]',N'$emapData[3]',N'$emapData[4]',N'$emapData[5]',N'$emapData[6]',N'$emapData[7]',N'$emapData[8]',N'$emapData[9]',N'$emapData[10]',N'$emapData[11]',N'$emapData[12]',N'$emapData[13]')";*/
             $sql = "INSERT into   flim_english(id,flimname,year,musdir,lang,totsongs,prodbanner,fproducer,fdirector,actors,actresses,coartists,photography,editing,rdate) values (N'$emapData[0]',N'$emapData[1]',N'$emapData[2]',N'$emapData[3]',N'$emapData[4]',N'$emapData[5]',N'$emapData[6]',N'$emapData[7]',N'$emapData[8]',N'$emapData[9]',N'$emapData[10]',N'$emapData[11]',N'$emapData[12]',N'$emapData[13]',N'$emapData[14]')";
...
{
	extract($_REQUEST);
	 $sql1 = "INSERT into   flim_english(id,flimname,year,musdir,lang,totsongs,prodbanner,fproducer,fdirector,actors,actresses,coartists,photography,editing,rdate) values ('".$fid."','".$fname."','".$year."','".$musdir."','".$lang."','".$tsong."','".$banner."','".$prod."','".$dir."','".$actor."','".$actress."','".$artist."','".$photo."','".$edit."','".$rdate."')";
			mysql_query("set character_set_results='utf8'");
            mysql_query($sql1);
			echo success('Film Added Succussfully ');
	
}
?>
<form enctype="multipart/form-data" method="post" role="form">
<div class="dash_count">
<table width="390" style="float:left;" class="dash_count_table" cellspacing="0">
<tr class="tr_th">
...
<table width="450" class="dash_count_table" style="float:right; margin-right: 86px;
    margin-top: -31px;" cellspacing="0">
<tr>
<tr>
<td>Film Id</td><td><input type="text" name="fid"/></td></tr>
<tr><td>Film name</td><td><input type="text" name="fname"/></td></tr>
<tr><td>Year</td><td><input type="text" name="year"/></td></tr>
<tr><td>Music Director</td><td><input type="text" name="musdir"/></td></tr>
<tr><td>Language</td><td><input type="text" name="lang"/></td></tr>
<tr><td>Total Song</td><td><input type="text" name="tsong"/></td></tr>
<tr><td>Production Banner</td><td><input type="text" name="banner"/></td></tr>
<tr><td>Producer</td><td><input type="text" name="prod"/></td></tr>
<tr><td>Director</td><td><input type="text" name="dir"/></td></tr>
<tr><td>Actor</td><td><input type="text" name="actor"/></td></tr>
<tr><td>Actress</td><td><input type="text" name="actress"/></td></tr>
<tr><td>Co-Artist</td><td><input type="text" name="artist"/></td></tr>
<tr><td>Photography</td><td><input type="text" name="photo"/></td></tr>
<tr><td>Editing</td><td><input type="text" name="edit"/></td></tr>
<tr><td>Release Date</td><td><input type="text" name="rdate"/></td></tr>
<tr>
<td align="center" colspan="2"><input type="submit" name="sub1" value="Insert Film"/></td>
</tr>
</table>
</form> 
</div>
