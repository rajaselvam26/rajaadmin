...
$val=mysql_query("select * from flim_tamil");
$cou=mysql_num_rows($val);


if(isset($_REQUEST['del_id'])){
$del=mysql_query("delete from flim_tamil where id='".$_REQUEST['del_id']."'");
...
<div class="title-box">
<h2><b>All Films (Tamil)&nbsp;(<?php echo $cou; ?>)</b></h2>
</div>
...
<?php
mysql_query("set character_set_results='utf8'");
$vtb=mysql_query("select * from flim_tamil");
...
<td align='left'><a href='?Theme_admin=all_filmtam&Document Management&id=<?php echo $r->id?>&n=1'>Edit</a></td></tr>
<?php } ?>
<?php //} ?>
</tr>
</table>
...
$id=$_GET['id'];
mysql_query("set character_set_results='utf8'");
$vtb1=mysql_query("select * from flim_tamil where id='$id'");
$r1=mysql_fetch_object($vtb1);
if($n==1)
{
	?>
	<div id="apDiv1" style="overflow:auto; width:360px  !important; height:600px; !important;"><div align="right"><a href="?Theme_admin=all_filmtam&Document Management">Close</a></div>
