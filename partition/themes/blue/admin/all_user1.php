...
$uid=$_GET['uid'];
if($m==1){
	$v=mysql_query("select * from users where id='".$uid."'");
	$ft=mysql_fetch_object($v);
	if(($ft->flag)==0){
		mysql_query("update users set flag='1' where id='$uid'");		
	}else if(($ft->flag)==1){
		mysql_query("update users set flag='0' where id='$uid'");
	}
}
if(isset($_REQUEST['del_id'])){
$del=mysql_query("delete from users where id='".$_REQUEST['del_id']."'");
echo "Deleted !";
}
if(isset($_POST['sub']))
{
$uid=$_GET['uid'];
	...
	mysql_query("update users  set name='".$fname."',
	email='".$email."',gender='".$gender."',dob='".$bdate."',address='".$addr."',
	phno='".$phone."'
	where id='$uid'");
...
<table width="786" class="dash_count_table" cellspacing="0">
<tr class="tr_th">
<th>User Name</th>
<th>Name</th>
...
<?php
$vtb=mysql_query("select * from users");
...
<?php if(($r->flag)==1){ ?><td>
<a href="?Theme_admin=all_user&User Management&uid=<?php echo $r->id; ?>&m=1">Inactive</a></td><td>Active</td> 
<?php }else if(($r->flag)==0){?><td>
<a href="?Theme_admin=all_user&User Management&uid=<?php echo $r->id; ?>&m=1">Active</a></td><td>Inactive</td> 
<?php }?>
<td><a href="javascript:void('0');" onclick="return delete_me('<?php echo $r->id;?>');">Delete</a>&nbsp;/&nbsp;
<a href='?Theme_admin=all_user&User Management&uid=<?php echo $r->id?>&n=1'>Edit</a>&nbsp;/&nbsp;
<a href='?Theme_admin=all_user&User Management&uid=<?php echo $r->id?>&n=2'>View</a></td>
...
$n=$_GET['n'];
$uid=$_GET['uid'];
$vtb1=mysql_query("select * from users where id=$uid");
$r1=mysql_fetch_object($vtb1);
if($n==1)
{
	?>

<div id="apDiv1"><div align="right"><a href="?Theme_admin=all_user&User Management">close</a></div>
<?php
if($msg==1){
	echo success('Updated');
}
?><form name="form1" method="post" enctype="multipart/form-data">
<table width="523" class="dash_count_table" cellspacing="0" align="center"><tr><p></p></tr><tr><p></p></tr>
<tr>
<td>First name</td><td><input type="text" name="fname" value="<?=$r1->name;?>"/></td></tr>
<tr><td>Email</td><td><input type="text" name="email" value="<?=$r1->email;?>"/></td></tr>

<tr><td>Gender</td><td><select name="gender"><option>Male</option><option>Female</option></select></td></tr>
<tr><td>Birth Date</td><td><input type="text" name="bdate" value="<?=$r1->dob;?>"/></td></tr>
<tr><td>Address</td><td><textarea name="addr"><?=$r1->address;?></textarea></td></tr>
<!--<tr><td>Country</td><td><input type="text" name="country" value="<?=$r1->country;?>"/></td></tr>
<tr><td>State</td><td><input type="text" name="state" value="<?=$r1->state;?>"/></td></tr>
<tr><td>City</td><td><input type="text" name="city" value="<?=$r1->city;?>"/></td></tr>
<tr><td>Zip Code</td><td><input type="text" name="cod" value="<?=$r1->zip;?>"/></td></tr>-->
<tr><td>Phone</td><td><input type="text" name="phone" value="<?=$r1->phno;?>"/></td></tr>
<tr>
<td align="center" colspan="2"><input type="submit" name="sub" value="Update User"/></td>
</tr>
</table>
</form>
</div>
...
?>
<div id="apDiv2"><div align="right"><a href="?Theme_admin=all_user&User Management">Close</a></div>
<table width="523" class="dash_count_table" cellspacing="0" align="center"><tr><p></p></tr><tr><p></p></tr>
<tr>
<td>First name</td><td><input type="text" name="fname" value="<?=$r1->name;?>" readonly="readonly"/></td></tr>
<tr><td>Email</td><td><input type="text" name="email" value="<?=$r1->email;?>" readonly="readonly"/></td></tr>
<tr><td>Gender</td><td><input type="text" name="gender" value="<?=$r1->gender;?>"/ readonly="readonly"></td></tr>
<tr><td>Birth Date</td><td><input type="text" name="bdate" value="<?=$r1->dob;?>" readonly="readonly"/></td></tr>
<tr><td>Address</td><td><textarea name="addr" readonly="readonly"><?=$r1->address;?></textarea></td></tr>
<!--<tr><td>Country</td><td><input type="text" name="country" value="<?=$r1->country;?>" readonly="readonly"/></td></tr>
<tr><td>State</td><td><input type="text" name="state" value="<?=$r1->state;?>" readonly="readonly"/></td></tr>
<tr><td>City</td><td><input type="text" name="city" value="<?=$r1->city;?>" readonly="readonly"/></td></tr>
<tr><td>Zip Code</td><td><input type="text" name="cod" value="<?=$r1->zip;?>" readonly="readonly"/></td></tr>-->
<tr><td>Phone</td><td><input type="text" name="phone" value="<?=$r1->phno;?>" readonly="readonly"/></td></tr>
