...
$val=mysql_query("select * from flim_english");
$cou=mysql_num_rows($val);

if(isset($_REQUEST['del_id'])){
$del=mysql_query("delete from  flim_english where id='".$_REQUEST['del_id']."'");
...
mysql_query("update  flim_english set id=N'".$id."',flimname=N'".$flimname."',year=N'".$year."',musdir=N'".$musdir."',lang=N'".$lang."',totsongs=N'".$totsongs."',prodbanner=N'".$prodbanner."',fdirector=N'".$fdirector."',fproducer=N'".$fproducer."',actors=N'".$actors."',actresses=N'".$actresses."',coartists=N'".$coartists."',photography=N'".$photography."',editing=N'".$editing."',rdate=N'".$rdate."',prodbanner=N'".$prodbanner."' where id='".$id."'");

header("location:?Theme_admin=all_filmeng&Document Management");
	}
?>  
<script>
...
<div id="container" style="overflow:auto; height:500px; width:1077px !important;">
<div class="title-box">
<h2><b>All Films (English)&nbsp;(<?php echo $cou; ?>)</b></h2>
</div>
...
<th width="52">Total Songs</th>
<th width="76">prodbanner</th>
<th width="56">Director</th>
<th width="60">Producer</th>
<th width="50">Actors</th>
<th width="51">Actress</th>
<th width="62">Coartists</th>
<th width="84">Photography</th>
<th width="47">Editing</th>
<th width="59">Release Date</th>
...
<?php
mysql_query("set character_set_results='utf8'");
$vtb=mysql_query("select * from  flim_english");
...
<td><?php echo $r->totsongs; ?></td>
<td><?php echo $r->prodbanner; ?></td>
<td><?php echo $r->fdirector; ?></td>
<td><?php echo $r->fproducer; ?></td>
<td><?php echo $r->actors; ?></td>
<td><?php echo $r->actresses; ?></td>
<td><?php echo $r->coartists; ?></td>
<td><?php echo $r->photography; ?></td>
<td><?php echo $r->editing; ?></td>
<td><?php echo $r->rdate; ?></td>

<?php /*?><?php if($r->page==1){ ?>
    <td>Home Page(Top Right)</td><?php } else if($r->page==2){?><td>Home Page (Bottom)</td><?php }?><?php */?>
<td><a href="javascript:void('0');" onclick="return delete_me('<?php echo $r->id?>');">Delete</a></td>
<td align='left'><a href='?Theme_admin=all_filmeng&Document Management&id=<?php echo $r->id?>&n=1'>Edit</a></td></tr>
<?php } ?>
<?php //} ?>
</tr>
</table>
...
$id=$_GET['id'];
mysql_query("set character_set_results='utf8'");
$vtb1=mysql_query("select * from  flim_english where id='$id'");
$r1=mysql_fetch_object($vtb1);
if($n==1)
{
	?>
	<div id="apDiv1" style="overflow:auto; width:360px  !important; height:600px; !important;"><div align="right"><a href="?Theme_admin=all_filmeng&Document Management">Close</a></div>
<table width="350" class="dash_count_table" cellspacing="0" align="center">

<tr>
<td width="52">Id</td>
<td align="center"><input type="text" name="id" id="title" value="<?= $r1->id;?>"/> </td>
</tr>
<tr>
<td width="52">Flim Name</td>
<td align="center"><input type="text" name="flimname" id="title" value="<?= $r1->flimname;?>"/> </td>
</tr>
<tr>
<td width="32">Year</td>
<td align="center"><input type="text" name="year" id="title" value="<?= $r1->year;?>"/> </td>
</tr>
<tr>
<td width="60">Music Director</td>
<td align="center"><input type="text" name="musdir" id="title" value="<?= $r1->musdir;?>"/> </td>
</tr>
<tr>
<td width="66">Language</td>
<td align="center"><input type="text" name="lang" id="title" value="<?= $r1->lang;?>"/> </td>
</tr>
<tr>
<td width="52">Total Songs</td>
<td align="center"><input type="text" name="totsongs" id="title" value="<?= $r1->totsongs;?>"/> </td>
</tr>
<tr>
<td width="76">prodbanner</td>
<td align="center"><input type="text" name="prodbanner" id="title" value="<?= $r1->prodbanner;?>"/> </td>
</tr>
<tr>
<td width="56">Director</td>
<td align="center"><input type="text" name="fdirector" id="title" value="<?= $r1->fdirector;?>"/> </td>
</tr>
<tr>
<td width="60">Producer</td>
<td align="center"><input type="text" name="fproducer" id="title" value="<?= $r1->fproducer;?>"/> </td>
</tr>
<tr>
<td width="50">Actors</td>
<td align="center"><input type="text" name="actors" id="title" value="<?= $r1->actors;?>"/> </td>
</tr>
<tr>
<td width="51">Actress</td>
<td align="center"><input type="text" name="actresses" id="title" value="<?= $r1->actresses;?>"/> </td>
</tr>
<tr>
<td width="62">Coartists</td>
<td align="center"><input type="text" name="coartists" id="title" value="<?= $r1->coartists;?>"/> </td>
</tr>
<tr>
<td width="84">Photography</td>
<td align="center"><input type="text" name="photography" id="title" value="<?= $r1->photography;?>"/> </td>
</tr>
<tr>
<td width="47">Editing</td>
<td align="center"><input type="text" name="editing" id="title" value="<?= $r1->editing;?>"/> </td>
</tr>
<tr>
<td width="59">Release Date</td>
<td align="center"><input type="text" name="rdate" id="title" value="<?= $r1->rdate;?>"/> </td>
</tr>
