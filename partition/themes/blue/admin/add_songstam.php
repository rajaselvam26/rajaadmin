   ...
   /* $host='localhost'; // Host Name.
    ...
    if($_FILES["file"]["size"] > 0)
    {
        ...
        while (($emapData = fgetcsv($file, 1000000, ",")) !== FALSE)
        {
            ...
            //print_r($emapData);
            //exit();
			/*echo "INSERT into  songs_tamil(fid,sid,sname,male_singer,female_singer,chrous,songlyrics,timings,lyricist,genre,fmtiming) values (N'$emapData[0]',N'$emapData[1]',N'$emapData[2]',N'$emapData[3]',N'$emapData[4]',N'$emapData[5]',N'$emapData[6]',N'$emapData[7]',N'$emapData[8]',N'$emapData[9]',N'$emapData[10]')";*/
			
           $sql = "INSERT into songs_tamil(fid,sid,sname,male_singer,female_singer,chrous,songlyrics,timings,lyricist,genre,fmtiming,imgflag) values(N'$emapData[0]',N'$emapData[1]',N'$emapData[2]',N'$emapData[3]',N'$emapData[4]',N'$emapData[5]',N'$emapData[6]',N'$emapData[7]',N'$emapData[8]',N'$emapData[9]',N'$emapData[10]',N'$emapData[11]')";
            mysql_query($sql);
        }
        fclose($file);
...
{
	extract($_REQUEST);
	 $sql1 = "INSERT into songs_tamil(fid,sid,sname,male_singer,female_singer,chrous,songlyrics,timings,lyricist,genre,fmtiming,imgflag) values('".$fid."',N'".$sid."',N'".$sname."',N'".$msinger."',N'".$fsinger."',N'".$chrous."',N'".$editor1."',N'".$time."',N'".$lyr."',N'".$genere."',N'".$fm."','".$flg."')";
			mysql_query("set character_set_results='utf8'");
            mysql_query($sql1);
			echo success('Song Added Succussfully ');
	
}
?>
<form enctype="multipart/form-data" method="post" role="form">
<div class="dash_count"  style="overflow:auto;">
<table width="390" class="dash_count_table" cellspacing="0">
<tr class="tr_th">
<!--<th align="center">Select Page</th>-->

    <div class="form-group">
        <td width="100">File Upload</td>
        <td><input type="file" name="file" id="file" size="150"></td>
        <p class="help-block">Please import as in CSV file format.</p>
    </div>
   <tr><td colspan="2" align="center"> <button type="submit" class="btn btn-default" name="Import" value="Import">Upload</button></td></tr>
</table>
</form>  
<form name="form1" method="post">
<table width="450" height="700" class="dash_count_table" style=" margin-right: 86px;
    margin-top:4px;" cellspacing="0">
<tr>
<tr>
<td>Film Id</td><td><input type="text" name="fid"/></td></tr>
<tr><td>Song Id</td><td><input type="text" name="sid"/></td></tr>
<tr><td>Song Name</td><td><input type="text" name="sname"/></td></tr>
<tr><td>Male Singer</td><td><input type="text" name="msinger"/></td></tr>
<tr><td>Female Singer</td><td><input type="text" name="fsinger"/></td></tr>
<tr><td>Chorus</td><td><input type="text" name="chorus"/></td></tr>
<td><td><div id="pc">
...
<tr><td>Timing</td><td><input type="text" name="time"/></td></tr>
<tr><td>Lyricist</td><td><input type="text" name="lyr"/></td></tr>
<tr><td>Genere</td><td><input type="text" name="genere"/></td></tr>
<tr><td>FM Timing</td><td><input type="text" name="fm"/></td></tr>
<tr><td>Image Flag</td><td><input type="text" name="flg"/></td></tr>

<tr>
<td align="center" colspan="2"><input type="submit" name="sub1" value="Insert Song"/></td>
</tr>
</table>
</form>  
</div>
