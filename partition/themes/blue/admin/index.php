...
$cou=mysql_num_rows($vtb);
// admin integration
class theme_admin{ // 
	public function left_menu(){ // left ,memu
		$menu = array(
			 "Film Management"=>array('<a href="?Theme_admin=all_filmeng&Film Management">All Films(English)'.$cou.'</a>',
			 '<a href="?Theme_admin=all_filmtam&Film Management">All Films(Tamil)</a> ' ,
			 '<a href="?Theme_admin=add_filmeng&Film Management">Add Film(English)</a>',
			 '<a href="?Theme_admin=add_filmtam&Film Management">Add Film(Tamil)</a>'),
			 
			 "Songs Management"=>array('<a href="?Theme_admin=all_songseng&Songs Management">All Songs(English)</a>',
			 '<a href="?Theme_admin=all_songstam&Songs Management">All Songs(Tamil)</a>',
			 '<a href="?Theme_admin=add_songseng&Songs Management">Add Songs(English)</a>',
			  '<a href="?Theme_admin=add_songstam&Songs Management">Add Songs(Tamil)</a>'),
			   "Albums Management"=>array('<a href="?Theme_admin=all_album&Albums Management">All Albums</a>',
			 '<a href="?Theme_admin=add_album&Albums Management">Add Album</a>'),
			  "MP3 Management"=>array('<a href="?Theme_admin=all_mp3&MP3 Management">All MP3</a>',
			 '<a href="?Theme_admin=add_mp3&MP3 Management">Add MP3</a>','<a href="?Theme_admin=view_mp3&MP3 Management">View All Mp3</a>'),
			 "Login Management"=>array('<a href="?Theme_admin=login&Login Management">Login</a>'),
			 "User Management"=>array('<a href="?Theme_admin=all_user&User Management">All User</a>'
			/* '<a href="?Theme_admin=add_user&User Management">Add User</a>'*/)
	...
	public function page(){
		include ('function.php');
		   /* echo '<link href="../'.current_theme_path().'admin/style.css" rel="stylesheet" type="text/css">';*/
			$plugin_page = $_REQUEST['Theme_admin'];
			switch($plugin_page){
				case 'all_filmeng':
				$plugin_page = include 'all_filmeng.php';
				break;
				case 'all_filmtam':
				$plugin_page = include 'all_filmtam.php';
				break;
				case 'add_filmeng':
				$plugin_page = include 'add_filmeng.php';
				break;
				case 'add_filmtam':
				$plugin_page = include 'add_filmtam.php';
				break;
				case 'all_songseng':
				$plugin_page = include 'all_songseng.php';
				break;
				case 'all_songstam':
				$plugin_page = include 'all_songstam.php';
				break;
				case 'add_songseng':
				$plugin_page = include 'add_songseng.php';
				break;
				case 'add_songstam':
				$plugin_page = include 'add_songstam.php';
				break;
				case 'all_album':
				$plugin_page = include 'all_album.php';
				break;
				case 'add_album':
				$plugin_page = include 'add_album.php';
				break;
				case 'all_mp3':
				$plugin_page = include 'all_mp3.php';
				break;
				case 'add_mp3':
				$plugin_page = include 'add_mp3.php';
				break;
				case 'view_mp3':
				$plugin_page = include 'view_mp3.php';
				break;
				case 'login':
				$plugin_page = include 'login1.php';
				break;
				case 'all_user':
				$plugin_page = include 'all_user.php';
				break;
