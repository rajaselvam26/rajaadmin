...
mysql_query("update  songs_tamil set sid=N'".$sid."',fid=N'".$flimname."',sname=N'".$musdir."',male_singer=N'".$lang."',female_singer=N'".$totsongs."',chrous=N'".$chrous."',songlyrics=N'".$editor1."',timings=N'".$fdirector."',lyricist=N'".$fproducer."',genre=N'".$fmusic."',fmtiming=N'".$actors."' where rid='".$id."'");
